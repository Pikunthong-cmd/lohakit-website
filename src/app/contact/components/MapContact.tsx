  ...
  return (
    <div className="bg-white container mx-auto ">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-10 items-start">
        {/* แผนที่: ทำเป็นกรอบอัตราส่วน 16:9 ให้ responsive */}
        <div className="w-full">
          <div className="relative w-full aspect-[16/9] overflow-hidden shadow-lg">
            <iframe
              ...
              title="แผนที่ บริษัท ทีเอ็น โลหะกิจ จำกัด"
            />
          </div>
        </div>
        <div className="flex flex-col justify-between h-full container mx-auto mt-5 px-4">
          <div>
