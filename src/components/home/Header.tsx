...
export default function Header() {
  ...
  // ปิด scroll หน้าเมื่อเปิดเมนูมือถือ
  useEffect(() => {
  ...
  return (
    <header className="w-full">
      ...
      <div className="bg-[#2B3990] text-sm text-white hidden md:block">
      ...
      <div className="bg-[#2B3990] text-sm text-white">
        <div className="container mx-auto px-4 py-2 flex justify-between items-center">
          ...
          {/* hamburger (mobile only) ย้ายมาอยู่ขวาสุดตรงนี้ */}
          <button
            type="button"
            onClick={() => setOpen(true)}
            className="md:hidden inline-flex items-center justify-center rounded focus:outline-none focus:ring-2 focus:ring-white/60"
